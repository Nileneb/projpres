        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        <h3 class="text-lg font-bold mb-2">{{ __('Challenge Details:') }}</h3>
                        <p><span class="font-medium">{{ __('From:') }}</span> {{ $match->creator->name }}</p>
                        <p><span class="font-medium">{{ __('To:') }}</span> {{ $match->solver->name }}</p>
                    ...
                    <form method="POST" action="{{ route('matches.submitSolution', $match) }}" class="mt-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Provide a URL to your solution (e.g., YouTube video, GitHub repository, etc.)') }}</p>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Add any additional notes or context about your solution.') }}</p>
