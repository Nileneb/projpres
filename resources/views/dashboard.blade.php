    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            ...
            <div class="relative aspect-video overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-4 flex flex-col items-center justify-center">
                ...
                <span class="text-lg font-semibold">My Challenges</span>
                <span class="text-sm text-neutral-600 dark:text-neutral-300">You have {{ auth()->user()->participants->flatMap->team->flatMap->createdMatches->count() }} created challenges</span>
            </div>
