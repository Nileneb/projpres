                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="{{ route('dashboard') }}"
                                    class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('dashboard') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 flex-shrink-0"
                            ...
                            <li>
                                <a href="{{ route('matches.index') }}"
                                    class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('matches.*') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3 flex-shrink-0"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <li>
                                <a href="{{ route('teams.index') }}"
                                    class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('teams.*') ? 'bg-gray-200 dark:bg-gray-700' : '' }}">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="https://github.com/laravel/livewire-starter-kit" target="_blank"
                                    class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
