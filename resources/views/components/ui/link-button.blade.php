<a {{ $attributes->merge(['class' => 'inline-flex items-center justify-center px-4 py-2 font-semibold text-xs uppercase tracking-widest shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition ease-in-out duration-150
